-- ponytail: drop/recreate to fix null end_at blocking future bookings that haven't started yet
...
begin
  ...
  if p_end_at is null then
    ...
    where b.vehicle_id = p_vehicle_id
      ...
      and ((b.end_at is null and b.start_at <= p_start_at) or b.end_at > p_start_at)
    limit 1;
