      ...
      <div className="mx-auto max-w-[800px] px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-[#071f52]/72">
          ...
          <section>
            ...
            <p>You have the right to access, update, or delete your personal information. You may also request a copy of the data we hold about you. To exercise these rights, contact us at {business.support_email}.</p>
          </section>

          <section>
            <h2 className="mb-2 text-lg font-black tracking-[-0.02em] text-[#071f52]">7. Contact</h2>
            <p>For privacy-related inquiries, contact Katada Transportation Services at {business.support_email} or {business.support_phone}.</p>
          </section>
        </div>
      </div>
    </div>
