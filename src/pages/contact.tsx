            ...
            <div className="rounded-[24px] border border-[#071f52]/10 bg-white p-6 shadow-[0_10px_30px_rgba(7,31,82,0.06)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-[#071f52]">{business.support_phone}</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[24px] border border-[#071f52]/10 bg-white p-6 shadow-[0_10px_30px_rgba(7,31,82,0.06)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-[#071f52]">{business.support_email}</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[24px] border border-[#071f52]/10 bg-white p-6 shadow-[0_10px_30px_rgba(7,31,82,0.06)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-[#071f52]">{business.business_address}</p>
                </div>
              </div>
            </div>
          </div>
