    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto grid min-h-[calc(100dvh-72px)] max-w-[1180px] items-center gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:py-14">
        <div className="mx-auto max-w-[620px] text-center lg:mx-0 lg:text-left">
          ...
          <p className="mx-auto mt-5 max-w-[500px] text-lg font-medium leading-8 text-[#071f52]/70 lg:mx-0">
        ...
        <div className="relative mx-auto w-full max-w-[610px] lg:ml-auto">
          ...
          <div className="absolute -bottom-5 left-1/2 grid w-[calc(100%-2.5rem)] max-w-[420px] -translate-x-1/2 grid-cols-3 gap-2 rounded-[24px] border border-white/80 bg-white/92 p-3 shadow-[0_18px_40px_rgba(7,31,82,0.18)] backdrop-blur sm:left-10 sm:w-[420px] sm:translate-x-0">
            {[
